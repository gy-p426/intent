...
5. 优先选择有注释说明的列
6. normalized_query中一定写明返回的数据列注释（即timestamp_column+value_column），并且标名返回几列数据，否则无法正确解析，如"获取日期、出车次数，返回日期、出车次数共2列数据"！！！
...
{{
  ...
  "normalized_query": "获取出车数据的日期、出车次数，返回日期、出车次数共2列数据"
}}"""
