# forecast_service/core/trend_analysis/__init__.py
"""
趋势分析模块
...
使用示例:
    from forecast_service.core.trend_analysis import router
    app.include_router(router, prefix="/api/v1")

    # 或直接使用服务
    from forecast_service.core.trend_analysis import TrendService
