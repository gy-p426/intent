# forecast_service/core/multivariate_forecast/__init__.py
"""
多变量预测模块
...
使用示例:
    from forecast_service.core.multivariate_forecast import router
    app.include_router(router, prefix="/api/v1")

    # 或直接使用预测器
    from forecast_service.core.multivariate_forecast import MultivariatePredictor
