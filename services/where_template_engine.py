...
class WhereTemplateEngine:
    ...
    def extract_params_from_where(self, where_clause: str, table_name: str = None) -> Tuple[str, Dict[str, Dict[str, Any]], Dict[str, str]]:
        """
        ...
        for match in string_matches:
            ...
            if table_name:
                options_query_sqls[param_key] = f"SELECT DISTINCT {column} FROM {table_name} WHERE {column} IS NOT NULL ORDER BY {column} LIMIT 100"
